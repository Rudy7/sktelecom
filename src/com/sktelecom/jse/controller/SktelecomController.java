	...
	public static void main(String[] args) {
		...
		while (true) {
			switch (JOptionPane.showInputDialog("[MENU]?\n" + "0. 정지\n" + "1. 개통\n" + "2. 목록\n" + "3. 고객정보\n"
											  + "4. 회원찾기\n" + "5. 변호변경\n" + "6. 회원탈퇴\n")) {
			case "0":
				JOptionPane.showMessageDialog(null, "SK 텔레콤을 찾아주셔서 감사합니다.    행복한 하루 되세요.   ");
			...
			case "1":
				...
				member.setName(JOptionPane.showInputDialog("이름을 적어주세요?"));
			...
			case "2":
				...
				break;
			case "3": // 고객정보
				JOptionPane.showMessageDialog(null, service.findByKey(JOptionPane.showInputDialog("고객번호를 입력해주세요?")));
				break;
			case "4": // 동명이인 찾기
				JOptionPane.showMessageDialog(null, service.findByName(JOptionPane.showInputDialog("이름을 적어주세요?")));
				break;
			case "5": // 번호 변경
				service.updatePhoneNumber(JOptionPane.showInputDialog("고객번호를 적어주세요?"));
				break;
			case "6": // 회원 탈퇴
				service.deleteMember(JOptionPane.showInputDialog("고객번호를 적어주세요?"));
				break;
